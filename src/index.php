...
<head>
	...
	<!-- descripcion -->
	<meta name="description" content="Somos especialistas en desarrollo de software, sitios web, Apps, digitalización de documentos y computación. Conoce nuestras soluciones en informática."/>
	...
	<nav id="barranav" class="navbar navbar-expand-lg fixed-top">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav ml-auto nav-pills">
	      ...
	      <li class="nav-item togglerItem">
	        <a class="nav-link barra collapseJQ" href="http://blog.devstar-novatech.com/">Blog</a>
	      </li>
	...
	<div class="container ">
		...
		<div class="row justify-content-center py-2 mt-2">
			...
			<div class="col-md-5 animIzq d-flex align-items-center">
				<img src="Img/informática.webp" alt="informática.webp" class="rounded mx-auto d-block align-self-center  img-fluid">	
			</div>
		</div>
		<div class="row justify-content-center py-2 mt-2">
			...
			<div class="col-md-5 animDer d-flex align-items-center">
				<img src="Img/consulSm.webp" alt="consulSm.webp" class="rounded mx-auto d-block align-self-center img-fluid">		
			</div>						
		</div>
		<div class="row justify-content-center py-4 animIzq">
			<div class="col-md-10 my-auto noMostrarMenor768">
				<img src="Img/soluciones.webp" alt="soluciones.webp" class="rounded mx-auto d-block align-self-center img-fluid">				 
			</div>			
		</div>
